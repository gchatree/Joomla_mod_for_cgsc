...
function jsonToGroupedData($jsonFilePath, $stu_id) {
    ...
    if ($stu_id === '0') {
        ...
        // Save to stu_id.json
        file_put_contents('sa_stu_id.json', json_encode($finalResult, JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT));
...
$spreadsheetId = '1sxibW_b8urfw_NfbitYt9ASyIqpxlaUcfM0wY2Dyss0';
$sheetName = 'student';
$lastUpdateFile = 'SA_lastupdate.txt';
$cellRange = 'A1';
...
if (sheet_updated($apiKey, $spreadsheetId, $sheetName, $cellRange, $lastUpdateFile)) {
    ...
    $datas = update_json($apiKey, $spreadsheetId, $sheetName, 'SA_student.json');
    jsonToGroupedData('SA_student.json','0');
}
//$tables = student_profile('student.json',$student_id);
$res = jsonToGroupedData('SA_student.json',$student_id);
